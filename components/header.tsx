...
export default function Header() {
  ...
  return (
    <nav className="flex items-center justify-between px-4 py-2 border-b border-gray-200 bg-background">
      ...
      {isMobileMenuOpen && (
        <div className="absolute top-full left-0 right-0 bg-background border-b border-gray-200 md:hidden">
