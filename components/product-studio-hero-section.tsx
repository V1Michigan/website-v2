    ...
    <section className="relative w-full overflow-hidden bg-white">
      <div className="relative min-h-[600px] w-full md:min-h-[750px] lg:min-h-[810px]">
        ...
        <motion.div
          ...
          className="absolute inset-y-0 left-0 w-full overflow-hidden md:left-auto md:right-0 md:w-[72%] md:max-w-[920px]"
        >
          <Image
        ...
        <motion.div
          ...
          className="absolute inset-y-0 left-0 hidden w-1/2 max-w-[640px] overflow-hidden md:block"
        >
          <Image
