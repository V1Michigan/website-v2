...
import ProgramSection from "@/components/events/program-section";
    ...
    <div className="min-h-screen bg-[#FEF9F5] snap-y snap-mandatory">
      ...
      {/* <TimelineSection title="Product Studio">
        <ProgramSection
          ...
          imageSrc="/events/product-studio/product-studio-img.jpg?height=600&width=1200"
      ...
      <TimelineSection title="Startup Week">
        <ProgramSection
          ...
          imageSrc="/events/startup-week/startup-week.png?height=600&width=1200"
      ...
      <TimelineSection title="Build Blue">
        <ProgramSection
          ...
          imageSrc="/events/build-blue/build-blue-img.JPG?height=600&width=1200"
          buttonText="Learn more"
      ...
      <TimelineSection title="Ship-Its">
        <ProgramSection
          ...
          imageSrc="/events/ship-it/ship-its-img.JPG?height=600&width=1200"
